...
uses
  ...
  public
    ...
    function  calculaDiffComTmpTaskTmpAlmocoTmpCafeMTmpCafeT         : TTime;
...
begin
    Result := Abs((difInitialTime) - (DifComCafeM) - (DifComCafT) - (DifComCafeM));
end;

function TtimeCalc.calculaDiffComTmpTaskTmpAlmocoTmpCafeMTmpCafeT: TTime;
begin
    Result := Abs((difInitialTime) - (difAlmoco) - (DifComCafT) - (DifComCafeM));
end;
